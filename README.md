...
+ [Definición de proyecto a realizar](#id1)
+ [Pregunta de investigación](#id2)
+ [Diseño del producto de datos (mockup)](#id3)
+ [Entregables](#id4)
+ [ETL](#id5)
+ [Orchestration](#id6)
+ [DAG](#id7)
+ [Implicaciones éticas](#id8)
+ [Modelo](#id9)
+ [Métrica del modelado](#id10)
...
### Pregunta de investigación<a name="id2"></a>
...
## Diseño del producto de datos (mockup)<a name="id3"></a>
...
### 5. Métrica del modelado<a name="id10"></a>
...
### 6. *Bias y Fairness*<a name="id11"></a>

##### 6.1 Atributo Protegido<a name="id12"></a>
...
##### 6.2 Métricas *Bias* y *Fairness*<a name="id13"></a>
