...
class extrae_todo(luigi.Task):
    """
    Fetches all records to a bunch of csv files in S3.
    """
    ...
    def requires(self):
        ...
        while record < nrecord:
            ...
            print("dentro del while", file, fname)
             #hacemos el requerimiento para un chunk del los registros
            response.append(extrae_chunk_api_a_S3(chunk_size, record, nrecord, bucket, root_path, etl_path, year, fname))
